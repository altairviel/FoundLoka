  ...
  return (
    <div>
        ...
        <div className="ff-container">
          <div style={{ maxWidth: 620 }}>
            ...
            <p style={{ fontSize: "1.1rem", color: T.gray500, lineHeight: 1.7, marginBottom: "2rem", maxWidth: 480 }}>
              Investasikan dana kamu ke ratusan UMKM terpilih di seluruh Indonesia.
      ...
      <section className="ff-section" style={{ background: T.gray50 }}>
        <div className="ff-container">
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: "2rem" }}>
            ...
            <button className="ff-btn ff-btn-sm" onClick={() => setPage("campaign")}>Lihat semua →</button>
          </div>
      ...
      <section style={{ padding: "3rem 0", background: T.gray50 }}>
        <div className="ff-container">
          <p style={{ fontSize: 12, color: T.gray500, marginBottom: "1rem", textTransform: "uppercase", letterSpacing: "0.08em", fontWeight: 600 }}>
