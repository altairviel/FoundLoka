        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 300px', gap: '2rem', alignItems: 'start' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            ...
            <div className="ff-card" style={{ display: 'flex', gap: '1.5rem', alignItems: 'center' }}>
              ...
              <div>
                ...
                <p style={{ color: T.gray500, fontSize: 14, marginBottom: 8 }}>Mahasiswa Teknik Informatika · Universitas Mikroskil</p>
                <div style={{ display: 'flex', gap: 8 }}>
                  ...
                  <span className="ff-badge ff-badge-green">{role === 'investor' ? 'Investor Aktif' : 'Pemilik Campaign'}</span>
                </div>
              </div>
            </div>
            ...
            <div className="ff-card">
              ...
              <p style={{ fontSize: 14, color: T.gray700, lineHeight: 1.7, marginBottom: '1.5rem' }}>
                Pengembang web dan sistem terintegrasi dengan ketertarikan kuat pada Data Science dan komputasi statistik. Memiliki pengalaman mengembangkan backend Node.js & Express, serta eksplorasi perangkat keras menggunakan
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            ...
            <div className="ff-card">
              ...
              <button className="ff-btn" style={{ width: '100%', fontSize: 13 }}>
                Edit Profil
              </button>
            </div>

            {/* Statistik Singkat */}
            <StatCard label={role === 'investor' ? 'Level Keanggotaan' : 'Status Campaign'} value={role === 'investor' ? 'Gold Tier' : 'Sedang Berjalan'} accent />
          </div>
        </div>
      </div>
    </div>
