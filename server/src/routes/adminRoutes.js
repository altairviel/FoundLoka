...
const { getStats, getAllCampaigns, approveCampaign, rejectCampaign, disburseCampaign } = require('../controllers/adminController');
...
router.put('/campaigns/:id/disburse', protect, adminOnly, disburseCampaign);
